export default function CarzyHeroSection() {
    return (
      <section className="relative bg-[#001317] text-white min-h-screen pt-28 px-8 flex flex-col items-center justify-center text-center overflow-hidden">
            ...
            >
              <animate
                ...
                values="
                  ...
                  M0,120 C400,260 1040,40 1440,180 L1440,320 L0,320 Z;
                  M0,160 C360,320 1080,0 1440,160 L1440,320 L0,320 Z
                "
              />
            </path>
